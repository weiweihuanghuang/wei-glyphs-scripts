#MenuTitle: Delete Kerning Pairs Between these Categories for This Masters
# -*- coding: utf-8 -*-
__doc__="""
"""
import GlyphsApp
...
print "\t{0}".format(selectedMaster.name)
...
for thisDeletionGroup in pairsToBeDeleted:
	...
	try:
		Font.removeKerningForPair( selectedMaster.id, firstGlyphName, secondGlyphName )
